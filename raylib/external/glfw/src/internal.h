...
#define eglGetConfigAttrib __glfw.egl.GetConfigAttrib
#define eglGetConfigs __glfw.egl.GetConfigs
#define eglGetDisplay __glfw.egl.GetDisplay
#define eglGetError __glfw.egl.GetError
#define eglInitialize __glfw.egl.Initialize
#define eglTerminate __glfw.egl.Terminate
#define eglBindAPI __glfw.egl.BindAPI
#define eglCreateContext __glfw.egl.CreateContext
#define eglDestroySurface __glfw.egl.DestroySurface
#define eglDestroyContext __glfw.egl.DestroyContext
#define eglCreateWindowSurface __glfw.egl.CreateWindowSurface
#define eglMakeCurrent __glfw.egl.MakeCurrent
#define eglSwapBuffers __glfw.egl.SwapBuffers
#define eglSwapInterval __glfw.egl.SwapInterval
#define eglQueryString __glfw.egl.QueryString
#define eglGetProcAddress __glfw.egl.GetProcAddress
...
#define eglGetPlatformDisplayEXT __glfw.egl.GetPlatformDisplayEXT
#define eglCreatePlatformWindowSurfaceEXT __glfw.egl.CreatePlatformWindowSurfaceEXT
...
#define OSMesaCreateContextExt __glfw.osmesa.CreateContextExt
#define OSMesaCreateContextAttribs __glfw.osmesa.CreateContextAttribs
#define OSMesaDestroyContext __glfw.osmesa.DestroyContext
#define OSMesaMakeCurrent __glfw.osmesa.MakeCurrent
#define OSMesaGetColorBuffer __glfw.osmesa.GetColorBuffer
#define OSMesaGetDepthBuffer __glfw.osmesa.GetDepthBuffer
#define OSMesaGetProcAddress __glfw.osmesa.GetProcAddress
...
#define vkGetInstanceProcAddr __glfw.vk.GetInstanceProcAddr
...
#define _GLFW_REQUIRE_INIT()                         \
    ...
    {                                                \
        ___glfwInputError(GLFW_NOT_INITIALIZED, NULL); \
        return;                                      \
    }
...
void __glfwPlatformInitTimer(void);
uint64_t ___glfwPlatformGetTimerValue(void);
uint64_t ___glfwPlatformGetTimerFrequency(void);

GLFWbool ___glfwPlatformCreateTls(_GLFWtls* tls);
void ___glfwPlatformDestroyTls(_GLFWtls* tls);
void* ___glfwPlatformGetTls(_GLFWtls* tls);
void ___glfwPlatformSetTls(_GLFWtls* tls, void* value);

GLFWbool ___glfwPlatformCreateMutex(_GLFWmutex* mutex);
void ___glfwPlatformDestroyMutex(_GLFWmutex* mutex);
void ___glfwPlatformLockMutex(_GLFWmutex* mutex);
void ___glfwPlatformUnlockMutex(_GLFWmutex* mutex);

void* __glfwPlatformLoadModule(const char* path);
void __glfwPlatformFreeModule(void* module);
GLFWproc __glfwPlatformGetModuleSymbol(void* module, const char* name);
...
void ___glfwInputWindowPos(_GLFWwindow* window, int xpos, int ypos);
...
void ___glfwInputWindowContentScale(_GLFWwindow* window,
...
void ___glfwInputKey(_GLFWwindow* window,
                   int key, int scancode, int action, int mods);
void ___glfwInputChar(_GLFWwindow* window,
...
void ___glfwInputDrop(_GLFWwindow* window, int count, const char** names);
...
GLFWbool __glfwSelectPlatform(int platformID, _GLFWplatform* platform);

GLFWbool ___glfwStringInExtensionString(const char* string, const char* extensions);
const _GLFWfbconfig* ___glfwChooseFBConfig(const _GLFWfbconfig* desired,
                                         const _GLFWfbconfig* alternatives,
                                         unsigned int count);
GLFWbool ___glfwRefreshContextAttribs(_GLFWwindow* window,
                                    const _GLFWctxconfig* ctxconfig);
GLFWbool ___glfwIsValidContextConfig(const _GLFWctxconfig* ctxconfig);

const GLFWvidmode* ___glfwChooseVideoMode(_GLFWmonitor* monitor,
                                        const GLFWvidmode* desired);
int ___glfwCompareVideoModes(const GLFWvidmode* first, const GLFWvidmode* second);
...
void* __glfw_realloc(void* pointer, size_t size);
void __glfw_free(void* pointer);
