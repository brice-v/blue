...
var Builtins = []*Builtin{
	...
	// Default headers seem to be host, user-agent, accept-encoding (not case sensitive for these check pictures)	// deno also used accept: */* (not sure what that is)
	{
		Name: "_fetch",
		Fun: func(args ...Object) Object {
			if len(args) != 5 {
	...
	{Name: "_sorted", Fun: nil, HelpStr: helpStrArgs{
	...
	{Name: "all", Fun: nil, HelpStr: helpStrArgs{
	...
	{Name: "any", Fun: nil, HelpStr: helpStrArgs{
	...
	{Name: "map", Fun: nil, HelpStr: helpStrArgs{
	...
	{Name: "filter", Fun: nil, HelpStr: helpStrArgs{
	...
	{Name: "load", Fun: nil, HelpStr: helpStrArgs{
...
func getBuiltinMap(bt BuiltinType) []*Builtin {
	switch bt {
