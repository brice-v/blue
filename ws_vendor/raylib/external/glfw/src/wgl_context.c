                                ...
                                const _GLFWfbconfig* fbconfig)
{
    ...
    if (__glfw.wgl.ARB_pixel_format)
    {
        ...
        if (__glfw.wgl.ARB_multisample)
            ADD_ATTRIB(WGL_SAMPLES_ARB);

        if (ctxconfig->client == GLFW_OPENGL_API)
        {
            if (__glfw.wgl.ARB_framebuffer_sRGB || __glfw.wgl.EXT_framebuffer_sRGB)
                ADD_ATTRIB(WGL_FRAMEBUFFER_SRGB_CAPABLE_ARB);
        }
        else
        {
            if (__glfw.wgl.EXT_colorspace)
    ...
    for (i = 0;  i < nativeCount;  i++)
    {
        ...
        if (__glfw.wgl.ARB_pixel_format)
        {
            ...
            if (ctxconfig->client == GLFW_OPENGL_API)
            {
                if (__glfw.wgl.ARB_framebuffer_sRGB ||
                    __glfw.wgl.EXT_framebuffer_sRGB)
                {
    ...
    closest = ___glfwChooseFBConfig(fbconfig, usableConfigs, usableCount);
    if (!closest)
    {
...
static void makeContextCurrentWGL(_GLFWwindow* window)
{
    if (window)
    {
        ...
        else
        {
            ...
            ___glfwPlatformSetTls(&__glfw.contextSlot, NULL);
        }
    }
    else
    {
...
static void swapIntervalWGL(int interval)
{
    ...
    if (__glfw.wgl.EXT_swap_control)
...
static int extensionSupportedWGL(const char* extension)
{
    ...
    if (__glfw.wgl.GetExtensionsStringARB)
        extensions = wglGetExtensionsStringARB(wglGetCurrentDC());
    else if (__glfw.wgl.GetExtensionsStringEXT)
        extensions = wglGetExtensionsStringEXT();

    if (!extensions)
        return GLFW_FALSE;

    return ___glfwStringInExtensionString(extension, extensions);
}
...
static GLFWglproc getProcAddressWGL(const char* procname)
{
    ...
    return (GLFWglproc) __glfwPlatformGetModuleSymbol(__glfw.wgl.instance, procname);
}
...
GLFWbool ___glfwInitWGL(void)
{
    ...
    if (__glfw.wgl.instance)
        return GLFW_TRUE;

    __glfw.wgl.instance = __glfwPlatformLoadModule("opengl32.dll");
    if (!__glfw.wgl.instance)
    {
        ___glfwInputErrorWin32(GLFW_PLATFORM_ERROR,
    ...
    __glfw.wgl.CreateContext = (PFN_wglCreateContext)
        __glfwPlatformGetModuleSymbol(__glfw.wgl.instance, "wglCreateContext");
    __glfw.wgl.DeleteContext = (PFN_wglDeleteContext)
        __glfwPlatformGetModuleSymbol(__glfw.wgl.instance, "wglDeleteContext");
    __glfw.wgl.GetProcAddress = (PFN_wglGetProcAddress)
        __glfwPlatformGetModuleSymbol(__glfw.wgl.instance, "wglGetProcAddress");
    __glfw.wgl.GetCurrentDC = (PFN_wglGetCurrentDC)
        __glfwPlatformGetModuleSymbol(__glfw.wgl.instance, "wglGetCurrentDC");
    __glfw.wgl.GetCurrentContext = (PFN_wglGetCurrentContext)
        __glfwPlatformGetModuleSymbol(__glfw.wgl.instance, "wglGetCurrentContext");
    __glfw.wgl.MakeCurrent = (PFN_wglMakeCurrent)
        __glfwPlatformGetModuleSymbol(__glfw.wgl.instance, "wglMakeCurrent");
    __glfw.wgl.ShareLists = (PFN_wglShareLists)
        __glfwPlatformGetModuleSymbol(__glfw.wgl.instance, "wglShareLists");
    ...
    dc = GetDC(__glfw.win32.helperWindowHandle);
    ...
    __glfw.wgl.GetExtensionsStringEXT = (PFNWGLGETEXTENSIONSSTRINGEXTPROC)
        wglGetProcAddress("wglGetExtensionsStringEXT");
    __glfw.wgl.GetExtensionsStringARB = (PFNWGLGETEXTENSIONSSTRINGARBPROC)
        wglGetProcAddress("wglGetExtensionsStringARB");
    __glfw.wgl.CreateContextAttribsARB = (PFNWGLCREATECONTEXTATTRIBSARBPROC)
        wglGetProcAddress("wglCreateContextAttribsARB");
    __glfw.wgl.SwapIntervalEXT = (PFNWGLSWAPINTERVALEXTPROC)
        wglGetProcAddress("wglSwapIntervalEXT");
    __glfw.wgl.GetPixelFormatAttribivARB = (PFNWGLGETPIXELFORMATATTRIBIVARBPROC)
        wglGetProcAddress("wglGetPixelFormatAttribivARB");

    // NOTE: WGL_ARB_extensions_string and WGL_EXT_extensions_string are not
    //       checked below as we are already using them
    __glfw.wgl.ARB_multisample =
        extensionSupportedWGL("WGL_ARB_multisample");
    __glfw.wgl.ARB_framebuffer_sRGB =
        extensionSupportedWGL("WGL_ARB_framebuffer_sRGB");
    __glfw.wgl.EXT_framebuffer_sRGB =
        extensionSupportedWGL("WGL_EXT_framebuffer_sRGB");
    __glfw.wgl.ARB_create_context =
        extensionSupportedWGL("WGL_ARB_create_context");
    __glfw.wgl.ARB_create_context_profile =
        extensionSupportedWGL("WGL_ARB_create_context_profile");
    __glfw.wgl.EXT_create_context_es2_profile =
        extensionSupportedWGL("WGL_EXT_create_context_es2_profile");
    __glfw.wgl.ARB_create_context_robustness =
        extensionSupportedWGL("WGL_ARB_create_context_robustness");
    __glfw.wgl.ARB_create_context_no_error =
        extensionSupportedWGL("WGL_ARB_create_context_no_error");
    __glfw.wgl.EXT_swap_control =
        extensionSupportedWGL("WGL_EXT_swap_control");
    __glfw.wgl.EXT_colorspace =
        extensionSupportedWGL("WGL_EXT_colorspace");
    __glfw.wgl.ARB_pixel_format =
        extensionSupportedWGL("WGL_ARB_pixel_format");
    __glfw.wgl.ARB_context_flush_control =
...
{
    if (__glfw.wgl.instance)
        __glfwPlatformFreeModule(__glfw.wgl.instance);
}
                               ...
                               const _GLFWfbconfig* fbconfig)
{
    ...
    if (ctxconfig->client == GLFW_OPENGL_API)
    {
        ...
        {
            if (!__glfw.wgl.ARB_create_context)
            {
        ...
        {
            if (!__glfw.wgl.ARB_create_context_profile)
            {
                ___glfwInputError(GLFW_VERSION_UNAVAILABLE,
    ...
    if (__glfw.wgl.ARB_create_context)
    {
        ...
        {
            if (__glfw.wgl.ARB_create_context_robustness)
            {
        ...
        {
            if (__glfw.wgl.ARB_context_flush_control)
            {
        ...
        {
            if (__glfw.wgl.ARB_create_context_no_error)
    ...
    else
    {
        ...
        if (!window->context.wgl.handle)
        {
            ___glfwInputErrorWin32(GLFW_VERSION_UNAVAILABLE,
                                 "WGL: Failed to create OpenGL context");
            return GLFW_FALSE;
        }
...
GLFWAPI HGLRC _glfwGetWGLContext(GLFWwindow* handle)
{
