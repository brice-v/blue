...
func NewRoot() *cobra.Command {
	return &cobra.Command{
		Use:   "ps",
		Short: "ps is a tool to list and diagnose Go processes.",
		Example: `  ps <cmd> <pid|addr> ...
  ps <pid> # displays process info
  ps help  # displays this help message`,
